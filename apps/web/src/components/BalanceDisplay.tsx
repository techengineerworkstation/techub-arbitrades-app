...
export default function BalanceDisplay({ balances }: BalanceDisplayProps) {
  return (
    <div className="card-metallic p-4 md:p-6">
      <h2 className="text-lg md:text-xl font-bold text-metallic-green-800 mb-4">Balances</h2>
      ...
      <div className="space-y-3 md:space-y-4">
        ...
        <div className="p-3 md:p-4 bg-beige-100 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-2 md:gap-3">
            <div>
              <div className="text-base md:text-lg font-bold text-metallic-green-700">
      ...
      {balances && balances.mexc_usdt > 0 && (
        <div className="mt-3 md:mt-4 p-3 bg-metallic-green-50 rounded-lg border border-metallic-green-100">
          <div className="text-xs text-gray-500 mb-1">Profit Retained (MEXC)</div>
          <div className="text-base md:text-lg font-bold text-metallic-green-600">
