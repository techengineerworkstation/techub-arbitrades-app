...
export default function PriceMonitor({ prices }: PriceMonitorProps) {
  return (
    <div className="card-metallic p-6">
      <h2 className="text-xl font-bold text-metallic-green-800 mb-4">Price Monitor</h2>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Poloniex Price */}
        <div className="p-4 bg-beige-100 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 bg-metallic-green-500 rounded-full flex items-center justify-center">
              <span className="text-white text-xs font-bold">P</span>
            </div>
            <span className="font-semibold text-gray-700">Poloniex</span>
          </div>
          <div className="text-2xl font-bold text-metallic-green-700">
        ...
        {/* Spread */}
        <div className="p-4 bg-metallic-green-50 rounded-lg border border-metallic-green-100">
        ...
        <div className="p-4 bg-beige-100 rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            <div className="w-8 h-8 bg-metallic-green-700 rounded-full flex items-center justify-center">
              <span className="text-white text-xs font-bold">M</span>
            </div>
            <span className="font-semibold text-gray-700">MEXC</span>
          </div>
          <div className="text-2xl font-bold text-metallic-green-700">
